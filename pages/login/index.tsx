    ...
    <div >
      ...
      <form
        ...
        <input
          ...
          background="white"
          className={clsx("text-black", textInputStyles.input, authFormStyles.form_margin)}
        />
        <input
          type="password"
          name="password"
          ...
          className={clsx("text-black", textInputStyles.input, authFormStyles.form_margin)}
        />
        <button disabled={isLoading} className="w-40 h-12 bg-gray-500 text-white rounded-full  disabled:opacity-25">
        ログイン
        </button>
