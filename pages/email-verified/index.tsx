    ...
    <div className={loginLayoutStyles.screen_wrapper}>
      ...
      {mode === 'verifyEmail' ? (
        ...
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">パスワードを再設定</h2>
            <form action="#">
                <div class="grid gap-4 sm:grid-cols-1 sm:gap-6">
                    <div class="w-full">
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-3/5 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="password" required=""/>
                        {errors.password ? <div>{errors.password}</div> : null}
                    </div>
                    <div class="w-full">
                        <label for="password2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">新しいパスワード（確認）</label>
